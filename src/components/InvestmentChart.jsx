...
export default function InvestmentChart({ schedule }) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-10 bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
      <h3 className="text-center text-lg font-bold text-blue-700 mb-2">Projected Future Value (PKR)</h3>
